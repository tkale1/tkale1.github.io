...
(function( $ ){
	...
	/* ----------------------------------------------------------- */
		...
		$('.mu-skill-progress-bar').appear(function() {
			...
			$('.mu-web-development-bar').LineProgressbar({
				percentage: 80,
				triggerOnce: true
			});

			$('.mu-database-bar').LineProgressbar({
				percentage: 85,
				triggerOnce: true
			});

			$('.mu-ios-bar').LineProgressbar({
				percentage: 80,
				triggerOnce: true
			});
			...
			$('.mu-react-native-bar').LineProgressbar({
				percentage: 65,
				triggerOnce: true
			});
			...
			$('.mu-confidence-bar').LineProgressbar({
				percentage: 95,
				triggerOnce: true
			});
